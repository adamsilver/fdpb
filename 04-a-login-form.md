...
![A basic login form with username and password fields.](./images/04/login-bad.png)
...
![A field labeled “username” (left) and “email address” (right).](./images/04/username-vs-email.png)
...
![A field labeled “username” (left) and “username or email address” (right).](./images/04/username-vs-username-and-email.png)
...
![The booking reference field without hint (left) and with hint (right).](./images/04/username-hint.png)
...
![Password field without hint (left) and with hint (right).](./images/04/login-hintless.png)
...
![Password field with password reveal component added.](./images/04/password-field.png)
...
![Santander bank password field with separate three text boxes for each requested character.](./images/04/santander.png)
...
![Password field with three separate text boxes (left) and a single text box (right).](./images/04/single-field.png)
...
![Button labeled “Log in” (left) and “Sign in” (right).](./images/04/button-text.png)
...
![Left password error message “The username and password doesn't match”. Right password error message “The password doesn't correspond to your username”.](./images/04/login-error.png)
...
![Left Tesco product list page. Right Tesco login page with a different layout.](./images/04/contextless.png)
...
![Page containing login and register forms.](./images/04/two-forms.png)
...
![Left the login page with a link to the register page. Right the register page with a link to the login page.](./images/04/link.png)
...
![Left forgot password link between last field and submit button. Right forgot password link before the form.](./images/04/tab.png)
...
![Medium social login buttons explaining “we won't post without asking”.](./images/04/medium-login-usage.png)
...
![Medium's settings page which lets users connect and disconnect the different social media accounts easily.](./images/04/medium-settings.png)
